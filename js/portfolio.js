...
$(function() {
    ...
    $grid.after('<div class="text-center"><a id="load-more" class="btn btn-info btn-md btn-arrow text-white m-t-20" href="javascript:void(0)"> <span>Load More <i class="ti-arrow-right"></i></span></a></div>');
